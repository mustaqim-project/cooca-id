...
class WhatsAppDeviceController extends Controller
{
    ...
    /**
     * Tampilkan daftar WA API Device milik Customer.
     */
    public function index()
    {
        $customerId = Auth::guard('customer')->id();
        $devices = WhatsAppDevice::where('owner_type', 'customer')
        ...
        return view('customer.whatsapp.index', compact('devices'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $device = WhatsAppDevice::create([
            ...
            'owner_id' => $customerId,
            'name' => $request->name,
            'session_id' => WhatsAppDevice::generateSessionId('customer', $customerId),
    ...
    public function show($key)
    {
        ...
        return view('customer.whatsapp.show', compact('device', 'qrCodeDataUrl', 'qrHtmlUrl'));
    }
    ...
    /**
     * Kirim Pesan & File Uji Coba dari Customer Portal UI.
     */
    ...
    public function destroy($key)
    {
        ...
        return redirect()->route('customer.whatsapp-devices.index')
