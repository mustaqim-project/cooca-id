                    ...
                    <div class="p-6 text-gray-900">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-gray-900"
                                        >Rp
                                        {{ withdrawal.amount.toLocaleString('id-ID") }}</span
                                    >
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600"
                                    ...
                                    <span class="font-medium text-gray-900"
                                        >- Rp
                                        {{ withdrawal.fee.toLocaleString('id-ID") }}</span
                                    >
                                </div>
                                <div
                                    class="border-t border-gray-200 pt-3 flex justify-between"
                                >
                                    ...
                                    <span class="text-indigo-600 font-bold"
                                        >Rp
                                        {{ withdrawal.net_amount.toLocaleString('id-ID") }}</span
                                    >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div
                                    v-if="withdrawal.approved_at"
                                    class="flex items-start gap-3"
                                >
                                    <div
                                        class="w-2 h-2 mt-2 rounded-full bg-blue-500"
                                    ></div>
                                    <div>
                                        <p
                                            class="text-sm font-medium text-gray-900"
                                ...
                                >
                                    <div
                                        class="w-2 h-2 mt-2 rounded-full bg-red-500"
                                    ></div>
                                    <div>
                                        <p
                                            class="text-sm font-medium text-gray-900"
                        ...
                        <div
                            v-if="withdrawal.rejection_reason"
