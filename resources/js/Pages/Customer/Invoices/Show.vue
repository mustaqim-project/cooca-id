                                ...
                                <div class="text-right">
                                    <div class="mb-2">
                                        ...
                                        <span
                                            ...
                                            >{{ new Date(invoice.created_at).toLocaleDateString('id-ID") }}</span
                                        >
                                    </div>
                                    <div>
                                        <span class="text-sm text-gray-700"
                                        ...
                                        <span
                                            class="text-sm font-medium"
                                            >{{ new Date(invoice.due_date).toLocaleDateString('id-ID") }}</span
                                        >
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="w-1/2 space-y-2">
                                        ...
                                        >
                                            ...
                                            <span class="text-gray-900"
                                                >Rp
                                                {{ invoice.subtotal.toLocaleString('id-ID") }}</span
                                            >
                                        </div>
                                        <div
                                            v-if="invoice.voucher_discount > 0"
                                            class="flex justify-between text-sm"
                                        >
                                            <span class="text-gray-600"
                                                >Diskon Voucher</span
                                            ...
                                            <span class="text-red-600"
                                                >- Rp
                                                {{ invoice.voucher_discount.toLocaleString('id-ID") }}</span
                                            >
                                        </div>
                                        <div
                                            class="flex justify-between text-base font-semibold border-t border-gray-200 pt-2"
                                        >
                                            <span class="text-gray-900"
                                                >Total</span
                                            >
                                            <span class="text-indigo-600"
                                                >Rp
                                                {{ invoice.amount.toLocaleString('id-ID") }}</span
                                            >
                                        </div>
                                    </div>
                                </div>
