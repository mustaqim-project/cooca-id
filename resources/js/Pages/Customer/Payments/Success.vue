                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <p class="text-center text-gray-600 mb-8">
                            Terima kasih telah melakukan pembayaran. Transaksi
                            Anda telah berhasil diproses.
                        </p>
                        ...
                        >
                            ...
                            <ul class="text-sm text-blue-800 space-y-1">
                                <li>
                                    • Lisensi Anda sedang diproses dan akan
                                    aktif dalam beberapa menit
                                </li>
                                <li>
                                    • Anda akan menerima email konfirmasi dengan
                                    detail akses
                                </li>
                                <li>
                                    • Cek halaman Lisensi untuk melihat
