                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <p class="text-center text-gray-600 mb-8">
                            Pembayaran Anda sedang menunggu konfirmasi. Silakan selesaikan pembayaran sesuai instruksi di bawah.
                        </p>
                        ...
                        <div v-if="va_number" class="mb-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
                            <h3 class="text-lg font-semibold text-blue-900 mb-4">Instruksi Pembayaran</h3>
                            <div class="space-y-4">
                                <div>
                                    <p class="text-sm text-blue-700 mb-2">Virtual Account Number:</p>
                                    <div class="flex items-center justify-between p-3 bg-white rounded border border-blue-200">
                                        <code class="text-lg font-mono text-blue-900">{{ va_number }}</code>
                                        <button
                                            @click="navigator.clipboard.writeText(va_number); alert('Nomor VA disalin!')"
                                ...
                                <div v-if="expiry_time" class="pt-4 border-t border-blue-200">
                                ...
                                <div class="pt-4 border-t border-blue-200">
                                    <ol class="text-sm text-blue-800 space-y-2 list-decimal list-inside">
                                        <li>Login ke mobile banking atau ATM bank Anda</li>
