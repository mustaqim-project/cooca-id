...
@section('title', 'Affiliator Login - ' . ($setting->company_name ?? config('app.name')))
...
<main class="auth-layout">
    ...
    <div class="auth-right auth-panel">
        <div class="form-panel">
            ...
            <p class="form-subtitle">Log in to your COOCA dashboard. <a href="{{ route('affiliator.register') }}">No account? Start free →</a></p>
            ...
            <!-- FORM -->
            <form id="loginForm" method="POST" action="{{ route('affiliator.login.submit') }}" novalidate>
                @csrf
            ...
            <p style="text-align:center;font-size:.9rem;margin-top:16px;">
                Don't have an account? <a href="{{ route('affiliator.register') }}" style="font-weight:700;">Start 30-day free trial →</a>
            </p>
        </div>
    </div>
</main>
