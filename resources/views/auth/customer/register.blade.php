                ...
                <div class="step-page" id="step2">
                    ...
                    <div class="input-wrap">
                        ...
                        <div class="position-relative">
                            ...
                            <input type="text" name="referral_code" class="input-field" placeholder="Enter referral code if you have one" value="{{ old('referral_code') }}">
                        </div>
                    </div>
