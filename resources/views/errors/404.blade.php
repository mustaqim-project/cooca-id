...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Cooca.id</title>
...
<body class="bg-slate-950 text-slate-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center space-y-6">
        <div class="relative inline-block">
            <div class="text-9xl font-extrabold tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-indigo-500 to-cyan-400 opacity-80">
                404
            </div>
            <div class="absolute -top-2 -right-2 w-4 h-4 rounded-full bg-cyan-400 animate-ping"></div>
        </div>
