                    ...
                    <div class="dashboard-mockup">
                        ...
                        <div class="dashboard-inner">
                            ...
                            <div class="db-chart-area">
                                ...
                                <svg class="mini-chart" viewBox="0 0 400 80" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" aria-label="Revenue chart">
                                    <defs>
                                    ...
                                    <path
                                        d="M0,60 C20,55 40,45 80,35 C120,25 140,50 180,40 C220,30 260,20 300,15 C340,10 370,25 400,20"
                                        stroke="#4F46E5" stroke-width="2.5" stroke-linecap="round" />
                                    <path
                                        d="M0,60 C20,55 40,45 80,35 C120,25 140,50 180,40 C220,30 260,20 300,15 C340,10 370,25 400,20 L400,80 L0,80Z"
                                        fill="url(#chartGrad)" />
                ...
                @if ($clients->count() > 0)
                    @foreach ($clients->merge($clients) as $client)
                        <div class="client-logo">
                            @if ($client->logo_path)
                                <img src="{{ Storage::url($client->logo_path) }}" alt="{{ $client->company_name }}"
    ...
    <section class="lp-section" id="products" aria-labelledby="products-heading">
        <div class="lp-container">
            <div class="lp-section-header reveal">
                ...
                <p class="lp-subheading">Pilih produk yang sesuai dengan jenis bisnis Anda. Semua sudah termasuk setup
                    &amp; training.</p>
            </div>
            ...
            @if ($products->count() > 0)
                <div class="products-grid reveal">
                    @foreach ($products->take(6) as $index => $product)
                            ...
                            if ($lowestPlan) {
                                ...
                                $period =
                                    $lowestPlan->duration_months >= 999
                                        ? '/ Lifetime'
                                        : ($lowestPlan->duration_months == 1
                                            ? '/ bulan'
                                            : '/' . $lowestPlan->duration_months . ' bln');
                            } else {
                        ...
                        @endphp
                        <article class="product-card reveal reveal-delay-{{ ($index % 3) + 1 }}"
                                ...
                                <div class="product-thumb">
                                    @if ($product->thumbnail_url)
                                        <img src="{{ $product->thumbnail_url }}" alt="{{ $product->name }}"
                                            width="380" height="220" loading="lazy"
                                    ...
                                    {{-- Rating Badge --}}
                                    <div
                                        style="position:absolute; bottom:12px; right:12px; background:rgba(0,0,0,.6); backdrop-filter:blur(8px); padding:4px 10px; border-radius:100px; display:flex; align-items:center; gap:4px; font-size:12px; font-weight:700; color:#f59e0b; z-index: 5;">
                                    ...
                                    @if ($product->category)
                                        <div
                                            style="position:absolute; top:12px; left:12px; background:var(--primary); padding:3px 10px; border-radius:100px; font-size:10px; font-weight:700; color:#fff; text-transform:uppercase; letter-spacing:.05em;">
                                    ...
                                    @if ($origPrice > 0 || $finalPrice > 0)
                                        <div class="product-pricing-glass-card">
                                            ...
                                            <div class="product-price-hero-row">
                                                ...
                                                <span
                                                    class="price-val">{{ number_format($finalPrice, 0, ',', '.') }}</span>
                                    ...
                                    @else
                                        <div class="product-pricing-glass-card">
                                            ...
                                            <p style="font-size: 12px; color: var(--text-muted); margin-top: 4px;">
                                                Kustomisasi modul sesuai kebutuhan korporasi</p>
                                        </div>
                                    @endif
                    ...
                    @php
                        $demoProducts = [
                            [
                                ...
                                'desc' =>
                                    'Cooca Auto mengelola proses estimasi & breakdown komponen & penjualan unit. Bengkel semakin terukur, efisien, dan memberikan pengalaman pelanggan lebih baik.',
                                'price' => '350.000',
                                'normal' => '700.000',
                                'discount' => '50',
                                'savings' => '350.000',
                            ...
                            [
                                ...
                                'category' => 'BOOKING & RESERVASI JASA',
                                'desc' =>
                                    'Sistem booking mandiri bagi Salon, Barbershop, Klinik, Estetika, Nail Art. Terintegrasi lengkap CRM Pelanggan dan laporan keuangan.',
                                'price' => '200.000',
                                'normal' => '400.000',
                                'discount' => '50',
                                'savings' => '200.000',
                            ...
                            [
                                ...
                                'category' => 'NOTARIS & LEGAL',
                                'desc' =>
                                    'Dirancang khusus untuk Kantor Notaris & Pejabat Pembuat Akta Tanah (PPAT). Manajemen dokumen legal, billing, klien, dan arsip.',
                                'price' => '500.000',
                                'normal' => '1.000.000',
                                'discount' => '50',
                                'savings' => '500.000',
                        ...
                        <article class="product-card reveal reveal-delay-{{ $i + 1 }}">
                            <div class="product-inner">
                                ...
                                <div class="product-thumb">
                                    ...
                                    <div
                                        style="position:absolute;top:12px;left:12px;background:var(--primary);padding:3px 10px;border-radius:100px;font-size:10px;font-weight:700;color:#fff;text-transform:uppercase;">
                                        {{ $demo['category'] }}</div>
                                </div>
                                <div class="product-body">
    ...
    <section class="lp-section section-bg-alt" id="dashboard-preview" aria-labelledby="preview-heading">
        <div class="lp-container">
            <div class="lp-section-header reveal">
                ...
                <p class="lp-subheading">Dashboard real-time yang mudah digunakan oleh siapapun, dari kasir hingga
                    direktur.</p>
            </div>
                ...
                <div class="preview-content">
                    ...
                    <div class="preview-screen active" id="preview-pos">
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;padding:24px;">
                            <div
                                style="background:var(--surface);border-radius:12px;border:1px solid var(--border);padding:20px;">
                                <div style="font-size:12px;font-weight:700;color:var(--text-muted);margin-bottom:12px;">
                                    TRANSAKSI HARI INI</div>
                                <div style="font-size:32px;font-weight:900;color:var(--text);letter-spacing:-.03em;">Rp
                                    8.4j</div>
                                <div style="font-size:12px;color:#22c55e;font-weight:600;margin-top:4px;">↑ +12% dari
                                    kemarin</div>
                            </div>
                            <div
                                style="background:var(--surface);border-radius:12px;border:1px solid var(--border);padding:20px;">
                                <div style="font-size:12px;font-weight:700;color:var(--text-muted);margin-bottom:12px;">
                                    TOTAL TRANSAKSI</div>
                                <div style="font-size:32px;font-weight:900;color:var(--text);letter-spacing:-.03em;">247
                                </div>
                                <div style="font-size:12px;color:var(--accent);font-weight:600;margin-top:4px;"><i
                                        class="fa-solid fa-credit-card"></i> Rata-rata Rp 34rb/trx</div>
                            </div>
                            <div
                                style="background:var(--surface);border-radius:12px;border:1px solid var(--border);padding:20px;grid-column:span 2;">
                                <div style="font-size:12px;font-weight:700;color:var(--text-muted);margin-bottom:16px;">
                                    TRANSAKSI TERBARU</div>
                                ...
                                @foreach ($rows as $row)
                                    <div
                                        style="display:grid;grid-template-columns: 1.2fr 2.5fr 1.5fr 1fr;gap:12px;align-items:center;padding:12px 0;border-bottom:1px solid var(--border);text-align:left;">
                                        <div style="font-size:12px;font-weight:700;color:var(--primary);">
                                            {{ $row[0] }}</div>
                                        <div style="font-size:13px;color:var(--text);">{{ $row[1] }}</div>
                                        <div style="font-size:13px;font-weight:700;color:var(--text);">{{ $row[2] }}
                                        </div>
                        ...
                        <div style="padding:24px;">
                            <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:16px;">
                                ...
                                @foreach ($fCards as $fc)
                                    <div
                                        style="background:var(--surface);border-radius:12px;border:1px solid var(--border);padding:20px;">
                                        <div class="clay-icon-sm" style="margin-bottom:12px;"><i
                                                class="{{ $fc[0] }}"></i></div>
                                        <div
                                            style="font-size:11px;color:var(--text-muted);font-weight:600;margin-bottom:4px;">
                                            {{ $fc[1] }}</div>
                                        <div
                                            style="font-size:22px;font-weight:800;color:var(--text);letter-spacing:-.02em;">
                                            {{ $fc[2] }}</div>
                                        <div
                                            style="font-size:12px;font-weight:600;color:{{ $fc[4] }};margin-top:4px;">
                                            {{ $fc[3] }}</div>
                                    </div>
                                @endforeach
                            </div>
                            <div
                                style="background:var(--surface);border-radius:12px;border:1px solid var(--border);padding:20px;">
                                <div style="font-size:12px;font-weight:700;color:var(--text-muted);margin-bottom:16px;">
                                    GRAFIK KEUANGAN — 6 BULAN</div>
                                <svg width="100%" height="100" viewBox="0 0 600 100" fill="none"
                                    aria-label="Finance chart">
                                    <defs>
                                        <linearGradient id="fg" x1="0" y1="0" x2="0"
                                            y2="1">
                                            <stop offset="0%" stop-color="#4F46E5" stop-opacity=".3" />
                                            <stop offset="100%" stop-color="#4F46E5" stop-opacity="0" />
                                        </linearGradient>
                                    </defs>
                                    <path d="M0,80 L100,65 L200,50 L300,40 L400,30 L500,20 L600,10" stroke="#4F46E5"
                                        stroke-width="2.5" stroke-linecap="round" />
                                    <path d="M0,80 L100,65 L200,50 L300,40 L400,30 L500,20 L600,10 L600,100 L0,100Z"
                                        fill="url(#fg)" />
                                    <path d="M0,90 L100,85 L200,80 L300,75 L400,70 L500,72 L600,68" stroke="#06B6D4"
                                        stroke-width="1.5" stroke-dasharray="4,4" stroke-linecap="round" />
                                </svg>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="padding:24px;">
                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
                                <div
                                    ...
                                    <div style="font-size:12px;color:#22c55e;font-weight:600;margin-top:4px;">+47 bulan ini
                                    </div>
                                </div>
                                <div
                                    style="background:var(--surface);border-radius:12px;border:1px solid var(--border);padding:20px;">
                                    ...
                                    <div style="font-size:12px;color:var(--accent);font-weight:600;margin-top:4px;">42.3%
                                        retention</div>
                                </div>
                            </div>
                            <div
                        ...
                        <div style="padding:24px;">
                            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:16px;">
                                ...
                                @foreach ($invStats as $s)
                                    <div
                                        style="background:var(--surface);border-radius:10px;border:1px solid var(--border);padding:16px;text-align:left;">
                                        <div class="clay-icon-sm" style="margin-bottom:10px;"><i
                                                class="{{ $s[0] }}"></i></div>
                                        <div style="font-size:10px;color:var(--text-muted);margin-bottom:2px;">
                                            {{ $s[1] }}</div>
                                        <div style="font-size:20px;font-weight:800;color:var(--text);">{{ $s[2] }}
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div
                                ...
                                @foreach ($inv as $item)
                                    <div
                                        style="display:grid;grid-template-columns: 2fr 1fr auto;gap:12px;align-items:center;padding:12px 0;border-bottom:1px solid var(--border);text-align:left;">
                                        <div style="font-size:13px;color:var(--text);font-weight:600;">{{ $item[0] }}
                                        </div>
                                        <div style="font-size:12px;color:var(--text-muted);">{{ $item[1] }}</div>
                                        <div style="text-align:left;">
                                            <span
                                                style="font-size:11px;font-weight:700;padding:4px 12px;border-radius:100px;background:{{ $item[2] === 'Kritis' ? 'rgba(239,68,68,.1)' : 'rgba(245,158,11,.1)' }};color:{{ $item[3] }};">{{ $item[2] }}</span>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
    ...
    <section class="lp-section" id="why" aria-labelledby="why-heading">
        <div class="lp-container">
            <div class="lp-section-header reveal">
                ...
                <p class="lp-subheading">Teknologi kelas enterprise yang sebelumnya hanya bisa dinikmati perusahaan besar,
                    kini hadir untuk bisnis Anda.</p>
            </div>
                ...
                @php
                    $whyItems = [
                        [
                            'fa-solid fa-cloud',
                            'Cloud Native',
                            'Berjalan di cloud modern dengan auto-scaling dan infrastruktur terdistribusi.',
                        ],
                        [
                            'fa-solid fa-shield',
                            'High Security',
                            'Enkripsi end-to-end, 2FA, audit log, dan compliance GDPR siap pakai.',
                        ],
                        [
                            'fa-solid fa-puzzle-piece',
                            'Modular',
                            'Aktifkan hanya fitur yang Anda butuhkan. Bayar sesuai pemakaian.',
                        ],
                        [
                            'fa-solid fa-building-columns',
                            'Multi Tenant',
                            'Kelola banyak outlet atau bisnis dalam satu akun terpusat.',
                        ],
                        [
                            'fa-solid fa-plug',
                            'API Ready',
                            'REST API & Webhook untuk integrasi dengan sistem Anda yang sudah ada.',
                        ],
                        [
                            'fa-solid fa-bolt',
                            'Realtime',
                            'Data transaksi dan laporan diperbarui secara realtime tanpa refresh.',
                        ],
                        [
                            'fa-solid fa-mobile-screen',
                            'Offline Ready',
                            'Tetap bisa beroperasi meski koneksi internet terputus sementara.',
                        ],
                        [
                            'fa-solid fa-robot',
                            'AI Ready',
                            'Laporan cerdas dan prediksi berbasis AI untuk pengambilan keputusan.',
                        ],
                    ];
                @endphp
                @foreach ($whyItems as $i => $item)
                    <div class="why-card reveal reveal-delay-{{ ($i % 4) + 1 }}">
                        <div class="why-icon clay-icon" style="margin-bottom: 20px;"><i class="{{ $item[0] }}"></i>
                        </div>
        ...
        <div class="lp-container">
            ...
            <div class="how-grid">
                ...
                <div class="how-step reveal reveal-delay-2">
                    ...
                    <p class="how-step-desc">Pilih modul yang sesuai bisnis Anda. Tim kami akan bantu setup dan konfigurasi
                        awal.</p>
                </div>
                <div class="how-step reveal reveal-delay-3">
                    ...
                    <p class="how-step-desc">Sistem langsung bisa digunakan. Kami sediakan training gratis untuk tim Anda.
                    </p>
                </div>
            </div>
                    ...
                    @foreach ($testimonials->take(6) as $index => $testimonial)
                        <div class="testimonial-card reveal reveal-delay-{{ ($index % 3) + 1 }}">
                            <div class="testimonial-stars">
                                @for ($s = 1; $s <= ($testimonial->rating ?? 5); $s++)
                                    <i class="fa-solid fa-star"></i>
                                @endfor
                                @for ($s = ($testimonial->rating ?? 5) + 1; $s <= 5; $s++)
                                    <span style="opacity:.3;"><i class="fa-solid fa-star"></i></span>
                                @endfor
                            </div>
                ...
                <div class="testimonials-grid">
                    @php
                        $demoTestimonials = [
                            [
                                'name' => 'Andi Kurniawan',
                                'role' => 'Founder Bengkel Jaya Pro',
                                'rating' => 5,
                                'content' =>
                                    'Cooca Auto membantu saya mengelola beberapa cabang sekaligus dengan lebih efisien. Laporan keuangan jadi lebih akurat, dan saya bisa fokus ekspansi bisnis.',
                            ],
                            [
                                'name' => 'dr. Melissa Furi',
                                'role' => 'Direktur Klinik Furi',
                                'rating' => 5,
                                'content' =>
                                    'EMR digital dari Cooca Klinik membuat klinik kami sangat terorganisir dan pelayanan pasien meningkat drastis. Sangat recommended!',
                            ],
                            [
                                'name' => 'Dewi Lestari',
                                'role' => 'Owner Salon Cantik Premium',
                                'rating' => 5,
                                'content' =>
                                    'Sistem booking dan reminder WhatsApp sangat membantu. No show berkurang hingga 70%. Saya tidak bisa bayangkan tanpa Cooca.id!',
                            ],
                        ];
                    @endphp
    ...
    <section class="lp-section section-bg-alt" id="blog" aria-labelledby="blog-heading">
        <div class="lp-container">
            ...
            <div class="pricing-grid reveal"
                style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 32px;">
                @forelse($latestPosts as $post)
                    <div class="pricing-card"
                        style="padding: 24px; text-align: left; display: flex; flex-direction: column; gap: 16px;">
                        @if ($post->featured_image)
                            <img src="{{ Storage::url($post->featured_image) }}" alt="{{ $post->title }}"
                                style="width: 100%; height: 200px; object-fit: cover; border-radius: 8px;">
                        @else
                            <div
                                style="width: 100%; height: 200px; background: var(--border-color); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                <i class="fa-solid fa-newspaper"
                                    style="font-size: 48px; color: var(--text-muted); opacity: 0.5;"></i>
                            </div>
                        @endif
                        ...
                        <h3
                            style="font-size: 20px; font-weight: 700; color: var(--text-color); margin: 0; line-height: 1.4;">
                            {{ $post->title }}
                        </h3>
                        <p
                            style="color: var(--text-muted); font-size: 15px; margin: 0; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden; line-height: 1.6;">
                            {{ $post->excerpt ?: Str::limit(strip_tags($post->content), 120) }}
                        </p>
                        <div style="margin-top: auto; padding-top: 16px;">
                            <a href="{{ route('blog.show', $post->slug) }}"
                                style="color: var(--primary); font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; transition: color 0.2s;">
    ...
    <section class="lp-section" id="faq" aria-labelledby="faq-heading">
        <div class="lp-container">
            <div class="lp-section-header reveal">
                ...
                <h2 class="lp-heading" id="faq-heading">Pertanyaan yang <span class="gradient-text">Sering Ditanya</span>
                </h2>
            </div>
                    ...
                    @php
                        $defaultFaqs = [
                            [
                                ...
                                'a' =>
                                    'Tidak sama sekali. COOCA.ID adalah platform berbasis cloud yang bisa diakses dari browser manapun — laptop, tablet, atau smartphone. Tidak ada instalasi yang diperlukan.',
                            ],
                            [
                                'q' => 'Berapa lama proses setup setelah daftar?',
                                'a' =>
                                    'Setup dasar bisa selesai dalam 24 jam kerja. Tim kami akan menghubungi Anda untuk konfigurasi awal dan training penggunaan sistem.',
                            ],
                            [
                                'q' => 'Apakah data saya aman di COOCA.ID?',
                                'a' =>
                                    'Keamanan data adalah prioritas utama kami. Semua data dienkripsi dengan AES-256, backup otomatis harian, dan infrastruktur kami memenuhi standar SOC2 dan ISO 27001.',
                            ],
                            [
                                'q' => 'Bisa digunakan untuk berapa banyak outlet?',
                                'a' =>
                                    'Tergantung paket yang Anda pilih. Starter mendukung 1 outlet, Professional hingga 5 outlet, dan Enterprise tidak terbatas. Anda bisa upgrade kapanpun.',
                            ],
                            [
                                'q' => 'Apakah ada biaya tersembunyi?',
                                'a' =>
                                    'Tidak ada biaya tersembunyi. Harga yang tercantum sudah all-inclusive termasuk hosting, update sistem, dan dukungan teknis dasar. Transparansi adalah nilai utama kami.',
                            ],
                            [
                                'q' => 'Bagaimana jika saya tidak puas?',
                                'a' =>
                                    'Kami menawarkan garansi uang kembali 30 hari tanpa syarat. Jika tidak puas dalam 30 hari pertama, kami kembalikan pembayaran Anda penuh.',
                            ],
                        ];
                    @endphp
    ...
    <section class="lp-section--sm" id="cta" aria-labelledby="cta-heading">
        <div class="lp-container">
            <div class="cta-section">
                ...
                <p class="cta-desc">
                    Bergabunglah bersama 1.000+ pengusaha di Indonesia yang telah mempercayakan sistem operasi mereka kepada
                    Cooca.id.
                </p>
