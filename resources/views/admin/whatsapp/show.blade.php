...
@section('title', $device->name . ' — WhatsApp Device — COOCA.ID Admin')
...
<div class="page-header">
    <div>
        <div class="breadcrumb">
            ...
            <span>/</span>
            <a href="{{ route('admin.whatsapp-devices.index') }}">WhatsApp Devices</a>
            <span>/</span>
            <span>{{ $device->name }}</span>
        </div>
        <h1 class="page-title">{{ $device->name }}</h1>
        <p class="page-subtitle">Session ID: <code class="text-primary font-mono">{{ $device->session_id }}</code></p>
    </div>
    <div class="page-actions">
        <a href="{{ route('admin.whatsapp-devices.index') }}" class="btn btn-outline">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px;">
    <!-- Left Column: QR Code & Connection Card -->
    <div class="card" style="align-self: start;">
        <div class="card-body" style="padding: 24px; text-align: center; display: flex; flex-direction: column; align-items: center;">
            <h3 style="margin-top: 0; font-size: 16px; font-weight: 700; color: #1E293B;">
                <i class="fa-solid fa-qrcode text-primary"></i> Scan Barcode WhatsApp
            </h3>
    ...
    <!-- Right Column: API Credentials, Testing, & Docs (Revealed after Connection) -->
    <div id="connectedFeaturesContainer" style="grid-column: span 2; display: {{ $device->status === 'connected' ? 'flex' : 'none' }}; flex-direction: column; gap: 24px;">
        ...
        <div class="card">
            <div class="card-body" style="padding: 24px;">
                <h3 style="margin-top: 0; font-size: 16px; font-weight: 700; color: #1E293B; border-bottom: 1px solid #E2E8F0; padding-bottom: 12px; margin-bottom: 16px;">
                    <i class="fa-solid fa-key text-primary"></i> Kredensial WhatsApp API (Gunakan di ERP / Booking)
                </h3>
                
                <div style="margin-bottom: 16px;">
                    <label style="display: block; font-size: 12px; font-weight: 600; color: #64748B; margin-bottom: 6px;">X-WA-API-KEY (Secret API Key Admin)</label>
        ...
        <div class="card">
            <div class="card-body" style="padding: 24px;">
                <h3 style="margin-top: 0; font-size: 16px; font-weight: 700; color: #1E293B; margin-bottom: 16px;">
                    <i class="fa-solid fa-paper-plane text-primary"></i> Uji Coba Pengiriman Pesan & File Langsung
                </h3>
                <form id="testSendForm" onsubmit="handleTestSendAjax(event, this)" action="{{ route('admin.whatsapp-devices.test-send', $device->uuid) }}" method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 16px;">
        ...
        <div class="card">
            <div class="card-body" style="padding: 24px;">
                <h3 style="margin-top: 0; font-size: 16px; font-weight: 700; color: #1E293B; border-bottom: 1px solid #E2E8F0; padding-bottom: 12px; margin-bottom: 16px;">
                    <i class="fa-solid fa-book text-primary"></i> Dokumentasi API Integrasi Lengkap (ERP / Booking / Custom Code)
                </h3>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <table class="data-table" style="font-size: 13px; width: 100%; border-collapse: collapse;">
                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 8px 12px; border: 1px solid #E2E8F0;"><code style="color: #4F46E5;">target</code></td>
                            ...
                            <tr>
                                <td style="padding: 8px 12px; border: 1px solid #E2E8F0;"><code style="color: #4F46E5;">message</code></td>
                                <td style="padding: 8px 12px; border: 1px solid #E2E8F0;">String</td>
                                <td style="padding: 8px 12px; border: 1px solid #E2E8F0;"><span class="badge badge-amber">Opsional</span></td>
                            ...
                            <tr>
                                <td style="padding: 8px 12px; border: 1px solid #E2E8F0;"><code style="color: #4F46E5;">url</code> / <code style="color: #4F46E5;">file</code></td>
                            ...
                            <tr>
                                <td style="padding: 8px 12px; border: 1px solid #E2E8F0;"><code style="color: #4F46E5;">filename</code></td>
                                <td style="padding: 8px 12px; border: 1px solid #E2E8F0;">String</td>
                                <td style="padding: 8px 12px; border: 1px solid #E2E8F0;"><span class="badge badge-amber">Opsional</span></td>
...
(function() {
    ...
    var ajaxUrl = "{{ route('admin.whatsapp-devices.status-ajax', $device->uuid) }}";
