...
@section('content')
    <div class="d-flex flex-column gap-4" style="max-width: 800px; margin: 0 auto;">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h2 class="mb-1 fw-bold text-capitalize">Edit Voucher</h2>
                <p class="text-secondary mb-0">Update promotional code settings and limits.</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.vouchers.update', $voucher->id) }}" method="POST"
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text"
                                ...
                                id="code" name="code" placeholder="Code" value="{{ old('code', $voucher->code) }}"
                                required>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-floating">
                            <input type="number"
                                ...
                                value="{{ old('value', $voucher->value) }}" min="0" required>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-floating">
                            <input type="number"
                                ...
                                id="max_uses" name="max_uses" placeholder="Max Uses"
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-floating">
                            <input type="date"
                                ...
                                value="{{ old('expires_at', $voucher->expires_at ? \Carbon\Carbon::parse($voucher->expires_at)->format('Y-m-d') : '') }}">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill px-4 shadow-sm hover-lift">
                        <i class="bi bi-check2 me-2"></i> Update Voucher
                    </button>
                </div>
            </form>
        </div>
