...
<div class="page-header">
    ...
    <div class="page-actions">
        <a href="{{ route('admin.product-categories.index') }}" class="btn btn-outline">← Back</a>
    </div>
</div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.product-categories.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-input" required value="{{ old('name') }}" placeholder="e.g. Retail Point of Sale">
            </div>
            
            <div class="form-group">
                <label class="form-label">Slug <span class="text-muted" style="font-weight: normal;">(leave blank to auto-generate)</span></label>
                <input type="text" name="slug" class="form-input" placeholder="e.g. retail-pos" value="{{ old('slug') }}">
            </div>

            <div class="form-group">
                <label class="form-label">Icon / Emoji</label>
                <input type="text" name="icon" class="form-input" placeholder="e.g. fa-solid fa-store or 🛒" value="{{ old('icon') }}">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-input" rows="4" placeholder="Briefly describe the categories of products in this group...">{{ old('description') }}</textarea>
            </div>
