...
@section('content')
    <div class="d-flex flex-column gap-4" style="max-width: 800px; margin: 0 auto;">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h2 class="mb-1 fw-bold text-capitalize">Create Product Category</h2>
                <p class="text-secondary mb-0">Fill in the details to create a new category.</p>
            </div>
        </div>

        <!-- Form Card -->
        <div class="card border-0 shadow-sm rounded-4 glass p-4 p-md-5">
            <form action="{{ route('admin.product-categories.store') }}" method="POST" class="d-flex flex-column gap-4">
                @csrf
