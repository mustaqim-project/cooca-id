...
@section('subtitle', 'Manage your email templates data.')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
        ...
        <div class="flex items-center space-x-3 w-full sm:w-auto">
                <a href="{{ route('admin.email-templates.create') }}" class="inline-flex items-center justify-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium rounded-lg shadow-sm transition-colors focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-surface-900">
            ...
            <table class="corporate-table">
                ...
                <tr class="hover:bg-surface-50 dark:bg-surface-900 dark:hover:bg-surface-700/50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        <form class="form-confirm-delete" action="{{ route('admin.email-templates.destroy', $template->id) }}" method="POST" class="inline form-confirm-delete" >
                            @csrf @method('DELETE')
