...
@section('subtitle', 'Update customer testimonial')
                            ...
                            <div class="col-md-6">
                                <div class="form-saas-group">
                                    ...
                                    <input class="form-saas-input @error('role') is-invalid @enderror" type="text"
                                        name="role" id="role" value="{{ old('role', $testimonial->role) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-saas-group">
                                    ...
                                    <input class="form-saas-input @error('company') is-invalid @enderror" type="text"
                                        name="company" id="company" value="{{ old('company', $testimonial->company) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-saas-group">
                                    ...
                                    <input class="form-saas-input @error('rating') is-invalid @enderror" type="number"
                                        name="rating" id="rating" value="{{ old('rating', $testimonial->rating) }}"
                                        min="1" max="5">
                                    @error('rating')
                                        <div class="form-saas-error">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12">
                                <div class="form-saas-group">
                                    ...
                                    <textarea class="form-saas-textarea @error('content') is-invalid @enderror" name="content" id="content" rows="5"
                                        placeholder="What the customer said..." required>{{ old('content', $testimonial->content) }}</textarea>
                                    @error('content')
                                        <div class="form-saas-error">{{ $message }}</div>
                                    @enderror
                                </div>
