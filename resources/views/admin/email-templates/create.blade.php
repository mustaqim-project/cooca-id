...
@section('content')
    <div class="d-flex flex-column gap-4" style="max-width: 1000px; margin: 0 auto;">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h2 class="mb-1 fw-bold text-capitalize">Create Email Template</h2>
                <p class="text-secondary mb-0">Design a reusable layout and content structure for emails.</p>
            </div>
        </div>

        <!-- Form Card -->
        <div class="card border-0 shadow-sm rounded-4 glass p-4 p-md-5">
            <form action="{{ route('admin.email-templates.store') }}" method="POST" class="d-flex flex-column gap-4">
                @csrf
                        ...
                        <div class="col-12 col-md-8">
                            <div class="form-floating">
                                <input type="text"
                                    ...
                                    id="name" name="name" value="{{ old('name') }}" placeholder="Template Name"
                                    required>
                            ...
                            <div class="form-floating">
                                <select
                                    ...
                                    <option value="Transactional"
                                        {{ old('category') == 'Transactional' ? 'selected' : '' }}>Transactional</option>
                                    ...
                                    '<!DOCTYPE html>
                                                                                                                                ...
                                                                                                                                <head>
                                                                                                                                    <style>
                                                                                                                                        ...
                                                                                                                                        .btn { display: inline-block; padding: 10px 20px; background: #0d6efd; color: white; text-decoration: none; border-radius: 6px; }
                                                                                                                                    </style>
                                                                                                                                </head>
                                                                                                                                <body>
                                                                                                                                    <div class="container">
                                                                                                                                        <!-- Add your content here --><h2>Hello {name}!</h2>
