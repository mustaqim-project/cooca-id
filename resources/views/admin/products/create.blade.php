...
<div class="space-y-6 max-w-6xl mx-auto">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="form-confirm-submit">
        @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="category_id" id="category_id" 
                            ...
                            <!-- Assuming categories are passed or fetched -->
                    ...
                    <div>
                        ...
                        <div class="mt-2 space-x-4 flex">
                            <label class="inline-flex items-center">
                                <input type="radio" class="form-radio text-primary-600 focus:ring-primary-500 h-4 w-4 border-surface-300 dark:border-surface-600" name="type" value="one_time" {{ old('type', 'one_time') == 'one_time' ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-surface-700 dark:text-surface-300">One-time Purchase</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" class="form-radio text-primary-600 focus:ring-primary-500 h-4 w-4 border-surface-300 dark:border-surface-600" name="type" value="subscription" {{ old('type') == 'subscription' ? 'checked' : '' }}>
