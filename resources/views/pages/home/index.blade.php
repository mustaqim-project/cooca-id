...
@section('title', 'Home - ' . ($setting->company_name ?? config('app.name')))
...
<!-- HERO SECTION -->
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 hero-content">
            <div class="badge-glow reveal">
              <i class="bi bi-circle-fill"></i> {!! setting('home.hero.badge', 'High-Ticket Business Infrastructure') !!}
            </div>
            ...
            <p class="hero-subtitle reveal reveal-delay-2">
              {!! setting('home.hero.subtitle', '<strong>Most businesses lose revenue through fragmented tools.</strong> Disconnected systems, recurring fees that never stop, and software that owns you — not the other way around. There\'s a better way.') !!}
            </p>
            <p
              class="hero-subtitle reveal reveal-delay-2"
              style="font-size: 0.95rem; margin-top: -16px"
            >
              {!! setting('home.hero.description', 'COOCA replaces the chaos with <strong>one integrated system</strong> — lifetime license, modular ERP, and full control over your digital business infrastructure.') !!}
            </p>
            <div class="hero-cta reveal reveal-delay-3">
              <a href="#pricing" class="btn-cooca btn-cooca-primary">
                {{ setting('home.hero.btn_primary', 'View Pricing') }} <i class="bi bi-arrow-right"></i>
              </a>
              <a href="#howitworks" class="btn-cooca btn-cooca-outline">
                <i class="bi bi-play-circle"></i> {{ setting('home.hero.btn_outline', 'How It Works') }}
              </a>
            </div>
            <div class="hero-stats reveal reveal-delay-4">
              <div>
                <div class="hero-stat-value">{{ setting('home.stats.1.value', '10,000+') }}</div>
                <div class="hero-stat-label">{{ setting('home.stats.1.label', 'Businesses Running on COOCA') }}</div>
              </div>
              <div>
                <div class="hero-stat-value">{{ setting('home.stats.2.value', '99.9%') }}</div>
                <div class="hero-stat-label">{{ setting('home.stats.2.label', 'System Uptime') }}</div>
              </div>
              <div>
                <div class="hero-stat-value">{{ setting('home.stats.3.value', '500M+') }}</div>
                <div class="hero-stat-label">{{ setting('home.stats.3.label', 'Secure Transactions') }}</div>
              </div>
            </div>
          </div>
          <div class="col-lg-6 hero-visual reveal reveal-delay-3">
              ...
              <div class="dashboard-body">
                <div class="dashboard-grid">
                  <div class="dash-widget">
                    <div class="dash-widget-title">{{ setting('home.dash.1.title', 'Revenue This Month') }}</div>
                    <div class="dash-widget-value text-accent">{{ setting('home.dash.1.value', '$284,500') }}</div>
                    <div class="dash-widget-change">
                      <i class="bi bi-arrow-up-right"></i> {{ setting('home.dash.1.change', '+24.5% growth') }}
                    </div>
                  </div>
                  <div class="dash-widget">
                    <div class="dash-widget-title">{{ setting('home.dash.2.title', 'Active Licenses') }}</div>
                    <div class="dash-widget-value">{{ setting('home.dash.2.value', '12,847') }}</div>
                    <div class="dash-widget-change">
                      <i class="bi bi-arrow-up-right"></i> {{ setting('home.dash.2.change', 'All protected') }}
                    </div>
                  </div>
            ...
            <div class="floating-card floating-card-1 float-anim">
              ...
              <div class="fc-label">{{ setting('home.card.1.title', 'System Status') }}</div>
              <div class="fc-value" style="color: #10b981">{{ setting('home.card.1.value', 'Protected ✓') }}</div>
            </div>
            <div class="floating-card floating-card-2 float-anim-delay">
              <div class="fc-icon blue">
                <i class="bi bi-graph-up-arrow"></i>
              </div>
              <div class="fc-label">{{ setting('home.card.2.title', 'Monthly Growth') }}</div>
              <div class="fc-value">{{ setting('home.card.2.value', '+Rp48jt MRR') }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row g-4">
          <div class="col-md-4 reveal">
            <div class="counter-item">
              ...
              <div class="counter-label">{{ setting('home.counter.1.label', 'Businesses Trust COOCA') }}</div>
            </div>
          </div>
          <div class="col-md-4 reveal reveal-delay-2">
            <div class="counter-item">
              ...
              <div class="counter-label">{{ setting('home.counter.2.label', 'Guaranteed Uptime SLA') }}</div>
            </div>
          </div>
          <div class="col-md-4 reveal reveal-delay-4">
            <div class="counter-item">
              ...
              <div class="counter-label">{{ setting('home.counter.3.label', 'Transactions Processed') }}</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-8 reveal">
            <div class="trust-anchor-card">
              ...
              <h3 style="font-size: 1.6rem; margin-bottom: 10px">
                {!! setting('home.trust.title.prefix', '1 Customer =') !!}
                {!! setting('home.trust.title.gradient', '<span class="text-gradient">1 Isolated System</span>') !!}
              </h3>
              <p
                style="
                  font-size: 1rem;
                ...
                "
              >
                {!! setting('home.trust.subtitle', 'Your own dedicated infrastructure. Fully separated. Independent security. Not shared — <strong>yours alone</strong>.') !!}
              </p>
      ...
      <div class="container">
        <div class="text-center">
          <div class="section-label reveal">
            <i class="bi bi-grid-3x3-gap-fill"></i> {{ setting('home.products.badge', 'Industry Solutions') }}
          </div>
          <h2 class="section-title reveal reveal-delay-1">
            {!! setting('home.products.title', 'Built for <span class="text-gradient">Every Industry</span>') !!}
          </h2>
          <p class="section-subtitle reveal reveal-delay-2">
            {!! setting('home.products.subtitle', 'Nine specialized business systems — each engineered to replace fragmented tools that drain your time, revenue, and peace of mind.') !!}
          </p>
        </div>
        ...
        <ul class="nav nav-tabs" id="productsTab" role="tablist">
          <li class="nav-item" role="presentation">
            <button
              ...
              id="tab-commerce"
              data-bs-toggle="tab"
              data-bs-target="#products-commerce"
              type="button"
              role="tab"
              aria-selected="true"
            >
              <i class="bi bi-bag-check me-2"></i>Commerce &amp; Retail
            </button>
          </li>
          <li class="nav-item" role="presentation">
            <button
              ...
              id="tab-hospitality"
              data-bs-toggle="tab"
              data-bs-target="#products-hospitality"
              type="button"
              role="tab"
              aria-selected="false"
            >
              <i class="bi bi-building me-2"></i>Hospitality &amp; Services
            </button>
          </li>
          <li class="nav-item" role="presentation">
            <button
              ...
              id="tab-professional"
              data-bs-toggle="tab"
              data-bs-target="#products-professional"
              type="button"
              role="tab"
              aria-selected="false"
            >
              <i class="bi bi-briefcase me-2"></i>Health &amp; Professional
            </button>
          </li>
        </ul>

        <div class="tab-content" id="productsTabContent">
          <!-- Tab 1: Commerce & Retail -->
          <div
            ...
            <div class="row g-4">
              <div class="col-lg-4 col-md-6 reveal">
                <div class="card-3d product-card" style="height: 100%">
                  ...
                  <div class="card-title">COOCA for Retail</div>
                  <div class="card-desc">
                    Replace fragmented POS, inventory, and loyalty tools with
                    one unified system that tracks every transaction across
                    every outlet in real time.
                  </div>
                  <div class="card-actions">
                    <a href="#" class="btn-cooca btn-cooca-outline btn-cooca-sm"
                      >Learn More</a
                    ><a
                      href="#"
              ...
              <div class="col-lg-4 col-md-6 reveal reveal-delay-1">
                <div class="card-3d product-card" style="height: 100%">
                  ...
                  <div class="card-title">COOCA for Salon &amp; Beauty</div>
                  <div class="card-desc">
                    Appointment booking, stylist management, and membership
                    programs — turn walk-ins into loyal customers without the
              ...
              <div class="col-lg-4 col-md-6 reveal reveal-delay-2">
                <div class="card-3d product-card" style="height: 100%">
                  ...
                  <div class="card-title">COOCA for Laundry</div>
                  <div class="card-desc">
                    Order tracking, delivery scheduling, and customer loyalty —
                    one system that turns daily chaos into predictable,
                    recurring revenue.
                  </div>
                  <div class="card-actions">
                    <a href="#" class="btn-cooca btn-cooca-outline btn-cooca-sm"
          ...
          <!-- Tab 2: Hospitality & Services -->
          <div class="tab-pane fade" id="products-hospitality" role="tabpanel">
            <div class="row g-4">
              <div class="col-lg-4 col-md-6 reveal">
                <div class="card-3d product-card" style="height: 100%">
                  <div class="card-glow"></div>
                  <div class="card-icon"><i class="bi bi-cup-hot"></i></div>
                  <div class="card-title">COOCA for Restaurant</div>
                  <div class="card-desc">
                    Table management, kitchen display system, and multi-outlet
                    control — know exactly which location is profitable at any
                    given moment.
                  </div>
                  <div class="card-actions">
                    <a href="#" class="btn-cooca btn-cooca-outline btn-cooca-sm"
              ...
              <div class="col-lg-4 col-md-6 reveal reveal-delay-1">
                <div class="card-3d product-card" style="height: 100%">
                  ...
                  <div class="card-title">COOCA for Hotel</div>
                  <div class="card-desc">
                    Room booking, housekeeping workflow, and revenue management
                    — stop leaving money on the table with manual occupancy
                    tracking.
                  </div>
                  <div class="card-actions">
                    <a href="#" class="btn-cooca btn-cooca-outline btn-cooca-sm"
              ...
              <div class="col-lg-4 col-md-6 reveal reveal-delay-2">
                <div class="card-3d product-card" style="height: 100%">
                  ...
                  <div class="card-title">COOCA for Rental</div>
                  <div class="card-desc">
                    Asset tracking, contract automation, and maintenance alerts
                    — always know where every asset is and when it's generating
                    revenue.
                  </div>
                  <div class="card-actions">
                    <a href="#" class="btn-cooca btn-cooca-outline btn-cooca-sm"
          ...
          <!-- Tab 3: Health & Professional -->
          <div class="tab-pane fade" id="products-professional" role="tabpanel">
            <div class="row g-4">
              <div class="col-lg-4 col-md-6 reveal">
                <div class="card-3d product-card" style="height: 100%">
                  <div class="card-glow"></div>
                  <div class="card-icon"><i class="bi bi-hospital"></i></div>
                  <div class="card-title">COOCA for Clinic</div>
                  <div class="card-desc">
                    Patient records, pharmacy, and billing — fully integrated so
                    your staff stops juggling four different apps for a single
                    patient visit.
                  </div>
                  <div class="card-actions">
                    <a href="#" class="btn-cooca btn-cooca-outline btn-cooca-sm"
              ...
              <div class="col-lg-4 col-md-6 reveal reveal-delay-1">
                <div class="card-3d product-card" style="height: 100%">
                  ...
                  <div class="card-title">COOCA for Workshop</div>
                  <div class="card-desc">
                    Service orders, spare parts management, and full customer
                    history — nothing slips through the cracks, and every job
                    gets paid on time.
                  </div>
                  <div class="card-actions">
                    <a href="#" class="btn-cooca btn-cooca-outline btn-cooca-sm"
              ...
              <div class="col-lg-4 col-md-6 reveal reveal-delay-2">
                <div class="card-3d product-card" style="height: 100%">
                  ...
                  <div class="card-title">COOCA for Education</div>
                  <div class="card-desc">
                    Student enrollment, tuition billing, and grade management —
                    one platform that parents, teachers, and administrators
    ...
    >
      <div class="container">
        <div class="text-center">
          <div class="section-label reveal">
            <i class="bi bi-puzzle-fill"></i> {{ setting('home.modules.badge', 'Business Capabilities') }}
          </div>
          <h2 class="section-title reveal reveal-delay-1">
            {!! setting('home.modules.title', 'Everything Your Business Needs to <span class="text-gradient">Scale</span>') !!}
          </h2>
          <p class="section-subtitle reveal reveal-delay-2">
            {!! setting('home.modules.subtitle', 'Ten integrated capabilities replacing dozens of separate subscriptions. Each one works with the others — because they were built to.') !!}
          </p>
        </div>
        ...
        <div class="row align-items-center g-5">
          <div class="col-lg-5 reveal">
            <div class="section-label">
              <i class="bi bi-shield-lock-fill"></i> Asset Protection
            </div>
            <h2 class="section-title">
              Your License Is <span class="text-gradient">Your Asset.</span> We
              Protect It.
            </h2>
            <p class="mb-4">
              Most software companies rent you access. COOCA gives you
              <strong>ownership</strong> — with lifetime licenses, domain
              binding, and enterprise-grade security that treats your business
              system as the valuable asset it is.
            </p>
            <a href="#pricing" class="btn-cooca btn-cooca-primary"
              >View Protection Options <i class="bi bi-arrow-right"></i
            ></a>
          </div>
          <div class="col-lg-7">
            <div class="row g-3">
          ...
          <div class="col-lg-8">
            <div class="accordion accordion-cooca" id="faqAccordion">
              ...
              <div class="accordion-item reveal reveal-delay-2">
                ...
                >
                  <div class="accordion-body">
                    It's simple: Sign Up → Choose Industry → Wait 30 Minutes →
              ...
              <div class="accordion-item reveal reveal-delay-5">
                ...
                >
                  <div class="accordion-body">
                    ...
                    systems complete within 3–5 business days.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 reveal reveal-delay-2">
            <div class="contact-info-item">
              ...
              <div>
                ...
                <p class="ci-text">support@cooca.io</p>
              </div>
            </div>
            <div class="contact-info-item">
              <div class="ci-icon"><i class="bi bi-whatsapp"></i></div>
              <div>
                <div class="ci-title">WhatsApp</div>
                <p class="ci-text">+62 812 3456 7890</p>
              </div>
            </div>
            <div class="contact-info-item">
              <div class="ci-icon"><i class="bi bi-geo-alt"></i></div>
              <div>
                <div class="ci-title">Office</div>
                <p class="ci-text">
                  Jl. Sudirman Kav. 52-53<br />Jakarta Selatan 12190
                </p>
              </div>
            </div>
          </div>
