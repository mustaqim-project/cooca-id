...
<head>
    ...
    <!-- ApexCharts -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/apexcharts@3.49.0/src/assets/apexcharts.css" />
    ...
    <aside class="app-sidebar" id="appSidebar" role="navigation" aria-label="Main navigation">
        ...
        <div class="sidebar-brand">
            <a href="{{ route('admin.dashboard') }}" class="sidebar-brand-link" aria-label="Go to dashboard">
                <span class="brand-logo-wrapper">
                    <i class="bi bi-grid-fill brand-icon"></i>
                </span>
                <span class="brand-text">
                    Cooca<span class="brand-accent">.id</span>
                </span>
            </a>
        ...
        <div class="sidebar-search-container">
            <div class="sidebar-search-box">
                ...
                <input type="text" class="sidebar-search-input" placeholder="Search menu..." id="menuSearchInput" aria-label="Search menu">
            </div>
        </div>
            ...
            <div class="header-right">
                ...
                <div class="header-search desktop-only">
                    <div class="search-input-wrapper">
                        <i class="bi bi-search search-icon"></i>
                        <input type="text" class="header-search-input" placeholder="Quick search... (Ctrl+K)" aria-label="Global search" id="globalSearchInput">
                ...
                <div class="header-actions">
                    ...
                    <!-- Fullscreen -->
                    <button class="header-action-btn" id="fullscreenToggle" title="Toggle fullscreen" aria-label="Toggle fullscreen">
                        <i class="bi bi-fullscreen"></i>
                    </button>

                    <!-- Notifications -->
                    <button class="header-action-btn notification-btn" title="Notifications" aria-label="View notifications">
                ...
                <div class="dropdown profile-dropdown">
                    <button class="profile-btn" data-bs-toggle="dropdown" id="profileDropdown" aria-expanded="false">
