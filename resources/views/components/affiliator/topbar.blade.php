    ...
    <div class="d-flex align-items-center gap-2 gap-md-3">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 p-0 glass overflow-hidden"
                ...
                <div class="overflow-auto" style="max-height: 300px;">
                    ...
                    <div class="p-4 text-center text-secondary fs-7">
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center gap-2 text-decoration-none dropdown-toggle-hide-arrow"
                ...
                <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->guard('affiliator')->user()->name ?? 'Affiliate') }}&background=0D8ABC&color=fff"
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 mt-2 glass">
                <li class="px-3 py-2 border-bottom">
                    <div class="fw-semibold">{{ auth()->guard('affiliator')->user()->name ?? 'Affiliate Partner' }}</div>
                    <div class="text-secondary fs-7">{{ auth()->guard('affiliator')->user()->email ?? 'affiliate@example.com' }}
                    </div>
                </li>
                <li><a class="dropdown-item py-2 hover-lift" href="{{ route('affiliator.profile.edit') }}"><i
                            class="bi bi-person me-2 text-secondary"></i> My Profile</a></li>
                <li>
                    <hr class="dropdown-divider">
                </li>
                <li>
                    <form action="{{ route('affiliator.logout') }}" method="POST" class="m-0">
                        @csrf
