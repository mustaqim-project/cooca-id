    ...
    <div class="glass w-100 mx-3 rounded-4 shadow-lg overflow-hidden animate__animated animate__fadeInDown animate__faster"
        ...
        <div class="p-2 overflow-auto" style="max-height: 400px;" id="cmdResults">
            ...
            <a href="{{ route('affiliator.referrals.index') }}"
                ...
                <div class="bg-light rounded p-2 text-secondary"><i class="bi bi-people"></i></div>
                <div class="flex-grow-1">
                    <div class="fw-medium">My Referrals</div>
                    <div class="text-secondary" style="font-size: 0.75rem;">View referral stats and links</div>
                </div>
            </a>

            <a href="{{ route('affiliator.commissions.index') }}"
                class="d-flex align-items-center gap-3 p-3 rounded-3 text-decoration-none text-body hover-lift cmd-item mt-1">
                <div class="bg-light rounded p-2 text-secondary"><i class="bi bi-cash-coin"></i></div>
                <div class="flex-grow-1">
                    <div class="fw-medium">Commissions</div>
                    <div class="text-secondary" style="font-size: 0.75rem;">View commission history</div>
                </div>
            </a>
            ...
            <a href="{{ route('affiliator.withdrawals.create') }}"
                ...
                <div class="flex-grow-1">
                    <div class="fw-medium text-primary">Request Withdrawal</div>
                    <div class="text-secondary" style="font-size: 0.75rem;">Withdraw available commissions</div>
                </div>
            </a>
        </div>
